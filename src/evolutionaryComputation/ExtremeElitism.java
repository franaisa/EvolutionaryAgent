 ...
 * generated by crossover between the survivors with higher survival probability.
 *
...
public class ExtremeElitism extends GeneticAlg {
    ...
    public ExtremeElitism (int GENERATIONS, int populationSize, CrossoverType crossoverType, Memoria memory) {
        ...
        for (int i = 0; i < population.length; ++i) {
            ...
            population [i] = new IndividualV1 (true, new ComplexFitness ());
        }
    ...
    public void selection() {
        ...
        for (int i = 0, k = population.length - 1; i < 15; ++i, --k) {
        ...
        // Create the new population
        for (int i = 15; i <population.length; ++i) {
            ...
            newPopulation [i] = new IndividualV1 (false, new ComplexFitness ());
