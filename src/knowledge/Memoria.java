...
public class Memoria {
    ...
    private void loadObject(boolean tablaItems, boolean tablaGenetico, int nGenes, boolean tablaAuxiliar){
        ...
        try {
            ...
            String genetico = "CREATE TABLE Genetico (posicion int not null, generacion int not null, deaths int not null, kills int not null, totalDamageGiven int not null, totalDamageTaken int not null, nSuperShields int not null, nShields int not null, totalTimeShock int not null, totalTimeSniper int not null, current int not null";
